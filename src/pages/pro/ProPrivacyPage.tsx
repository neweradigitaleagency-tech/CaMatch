...
import { ArrowLeft, Eye, Download, Shield } from "lucide-react";
    ...
    <div className="min-h-dynamic bg-cm-bg">
      <div className="sticky top-0 z-10 bg-cm-elevated/80 backdrop-blur-lg border-b border-cm-border">
        <div className="flex items-center h-14 px-5 gap-3">
          ...
          <h1 className="text-[18px] font-bold text-cm-text">Confidentialité</h1>
        </div>
      </div>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[13px] text-cm-text">Profil visible dans les recherches</span>
            </div>
            <Toggle enabled={visible} onChange={() => setVisible(!visible)} />
          </div>
        </motion.div>
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}
          className="bg-cm-elevated border border-cm-border rounded-[14px] p-5 space-y-3">
          <h2 className="text-[13px] font-bold text-cm-text">Mes données</h2>
          <button className="w-full flex items-center justify-between py-2 cursor-pointer active:scale-[0.97]">
            <div className="flex items-center gap-3">
              <Download className="w-4 h-4 text-cm-accent" />
              <span className="text-[12px] text-cm-text">Télécharger mes données</span>
            </div>
          </button>
          <button className="w-full flex items-center justify-between py-2 cursor-pointer active:scale-[0.97]">
            <div className="flex items-center gap-3">
              <Shield className="w-4 h-4 text-cm-accent" />
              <span className="text-[12px] text-cm-text">Supprimer mes données</span>
            </div>
          </button>
        </motion.div>
      </div>
