  ...
  return (
    <div className="space-y-4 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-[20px] font-bold text-gray-900">Fournisseurs</h1>
          <p className="text-[13px] text-gray-500 mt-1">{suppliers.length} fournisseurs</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-[14px] font-medium text-gray-500">Aucun fournisseur trouvé</p>
            ...
            <table className="w-full text-[12px]">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50/50">
                  ...
                  <th className="text-left font-semibold text-gray-600 px-4 py-3">Responsable</th>
                  <th className="text-left font-semibold text-gray-600 px-4 py-3">Ville</th>
                  <th className="text-left font-semibold text-gray-600 px-4 py-3">Produits</th>
                  <th className="text-left font-semibold text-gray-600 px-4 py-3">Commandes</th>
                  <th className="text-left font-semibold text-gray-600 px-4 py-3">Revenu</th>
                  <th className="text-left font-semibold text-gray-600 px-4 py-3">Commission</th>
