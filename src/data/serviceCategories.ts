...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      { name: "Coiffure", keywords: ["coiffure", "coiffeur", "coiffeuse", "coupe", "brushing", "salon", "cheveux", "tissage", "pose"] },
      { name: "Tresses & coiffures africaines", keywords: ["tresses", "tissage", "vanille", "nattes", "coiffure africaine", "perruque", "extension"] },
      { name: "Maquillage", keywords: ["maquillage", "make up", "maquilleuse", "mariage", "soirée", "événement", "beauté"] },
      { name: "Manucure & Pédicure", keywords: ["manucure", "pédicure", "pedicure", "ongles", "vernis", "pose d'ongles", "prothésie ongulaire"] },
      { name: "Soins de la peau", keywords: ["soin", "peau", "visage", "gommage", "hydratant", "nettoyant", "éclat", "corps"] },
      { name: "Spa & Massage", keywords: ["spa", "massage", "détente", "détente", "bien-être", "relaxation", "huile", "corps"] },
      { name: "Barbier", keywords: ["barbier", "barbe", "rasage", "coupe homme", "tailler", "coiffure homme", "moustache"] },
      { name: "Épilation", keywords: ["épilation", "epilation", "cire", "laser", "duvet", "lisse", "jambes"] },
      { name: "Esthétique & relooking", keywords: ["esthétique", "estheticienne", "relooking", "conseil image", "sourcils", "cils", "extensions"] },
    ],
  },
  {
    id: "sante-domicile",
    ...
    icon: "🩺",
    color: "from-[rgba(213,94,94,0.15)] to-[rgba(45,106,79,0.10)]",
    subcategories: [
      { name: "Infirmier à domicile", keywords: ["infirmier", "infirmière", "soins", "piqûre", "injection", "pansement", "perfusion", "vaccin", "plaie"] },
      { name: "Aide-soignant", keywords: ["aide soignant", "aide-soignant", "aide-soignante", "personne âgée", "dépendance", "toilette", "alitement", "accompagnement"] },
      { name: "Garde-malade", keywords: ["garde-malade", "garde malade", "malade", "surveillance", "nuit", "soin", "accompagnement"] },
      { name: "Kinésithérapeute", keywords: ["kinésithérapeute", "kinesitherapeute", "kiné", "kine", "massage thérapeutique", "rééducation", "physio", "articulation"] },
      { name: "Sage-femme à domicile", keywords: ["sage-femme", "sage femme", "accouchement", "grossesse", "suivi prénatal", "post-natal", "bébé"] },
      { name: "Analyse médicale à domicile", keywords: ["analyse", "prise de sang", "laboratoire", "test", "dépistage", "biologie", "échantillon"] },
      { name: "Vaccination à domicile", keywords: ["vaccin", "vaccination", "vacciné", "dose", "carnet de vaccination"] },
      { name: "Diététicien", keywords: ["diététicien", "diététicienne", "nutrition", "régime", "alimentation", "repas", "diabète"] },
      { name: "Pharmacien", keywords: ["pharmacien", "pharmacie", "ordonnance", "médicament", "conseil", "livraison médicament", "garde"] },
    ],
  },
  {
