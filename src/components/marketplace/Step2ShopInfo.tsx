...
export default function Step2ShopInfo() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        <h2 className="text-xl font-bold text-[#1A1A1A]">Informations de la boutique</h2>
        ...
        <>
          <div>
            ...
            <input
              ...
              className="w-full h-12 px-4 rounded-xl bg-white border border-gray-200 text-sm text-[#1A1A1A] outline-none focus:border-[#243318] transition-colors placeholder:text-gray-300"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 rounded-xl bg-white border border-gray-200 text-sm text-[#1A1A1A] outline-none focus:border-[#243318] transition-colors placeholder:text-gray-300 resize-none"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="text-xs font-semibold text-[#6B7280] uppercase tracking-wider mb-1.5 block">Téléphone</label>
          <input
            type="tel"
            value={draft.phone}
        ...
        <div>
          <label className="text-xs font-semibold text-[#6B7280] uppercase tracking-wider mb-1.5 block">Ville</label>
          <select
            value={draft.city}
            onChange={(e) => setShopField("city", e.target.value)}
            className="w-full h-12 px-4 rounded-xl bg-white border border-gray-200 text-sm text-[#1A1A1A] outline-none focus:border-[#243318] transition-colors appearance-none"
          >
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {draft.photos.length < 6 && (
            <button
              ...
              className="w-20 h-20 rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-gray-300 transition-colors"
            >
              <ImagePlus className="w-5 h-5 text-gray-400" />
              <span className="text-[9px] text-gray-400 font-medium">Ajouter</span>
            </button>
          )}
        </div>
      </div>
