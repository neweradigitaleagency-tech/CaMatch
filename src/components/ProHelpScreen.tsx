...
const FAQS: FaqItem[] = [
  ...
  { id: "f5", question: "Puis-je annuler une mission acceptée ?", answer: "Oui, mais des frais peuvent s'appliquer. Si vous annulez moins de 2h avant le rendez-vous, une pénalité de 5 000 F est déduite de vos gains.", category: "jobs" },
