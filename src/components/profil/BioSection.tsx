  ...
  return (
    <ProfileSection>
      <div className="bg-white border border-cm-border/40 rounded-[20px] p-4 shadow-sm">
        <h3 className="text-[11px] font-black text-cm-text-soft uppercase tracking-wider mb-2">À propos</h3>
        {editing ? (
          <EditableField
            value={pro.bio || ""}
            editing
          ...
          <>
            ...
            {bioLong && (
              <button onClick={() => setExpanded(!expanded)}
                className="text-[11px] font-black text-cm-text mt-1.5 cursor-pointer uppercase tracking-wider hover:text-cm-text-soft transition-colors">
