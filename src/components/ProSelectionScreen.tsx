      ...
      {isMatching ? (
        ...
        <main className="px-6 pt-6 flex-grow flex flex-col gap-5">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col gap-4">
                <div className="flex justify-between items-start">
                  <span className="bg-brand-lime text-brand-forest text-[9px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider flex items-center gap-1">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-xs font-extrabold uppercase tracking-wider text-secondary/70">
            ...
            {sortedPros.map((pro) => (
              ...
              >
                ...
                <div className="flex-grow min-w-0">
                  ...
                  <p className="text-[11px] text-on-surface-variant truncate mt-0.5">{pro.title}</p>
                  
                  {/* Stats line */}
                  <div className="flex items-center gap-3 mt-1.5 text-[10px] text-secondary font-bold">
                ...
                <div className="flex flex-col items-end shrink-0 border-l border-pale-mint/30 pl-3 gap-1">
                  <span className="text-[10px] text-secondary uppercase font-bold tracking-wider">Tarif</span>
                  ...
                  <button
                    ...
                    className="text-[9px] font-extrabold text-brand-forest bg-pale-mint px-2 py-1 rounded-full hover:bg-brand-lime/30 transition-colors flex items-center gap-0.5"
                  >
                    <UserIcon className="w-2.5 h-2.5" /> Profil
                  </button>
                  <span className="text-[8px] text-emerald-600 font-extrabold bg-emerald-50 px-1.5 py-0.5 rounded">Dispo</span>
                </div>
              </div>
            ))}
          </div>
